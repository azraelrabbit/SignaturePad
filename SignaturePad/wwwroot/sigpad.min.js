...
export default class Sigpad {
    ...
    constructor(element, options) {
        ...
        setTimeout(() => {
            ...
            //console.log('[SPAD]this._element.offsetWidth: ' + this._element.offsetWidth)

            //console.log('[SPAD]this._element.offsetHeight: ' + this._element.offsetHeight)

            //console.log('[SPAD]this._element.scrollHeight: ' + this._element.scrollHeight)
            ////scrollWidth
            //console.log('[SPAD]this._element.scrollWidth: ' + this._element.scrollWidth)

            //console.log('[SPAD]this._config.aspectRatio: ' + this._config.aspectRatio)
            //console.log('[SPAD]this._element.width: ' + this._element.width)
            //console.log('[SPAD]this._element.clientWidth: ' + this._element.clientWidth)
            if (this._config.aspectRatio > 0) {


                this._element.height = this._element.width / this._config.aspectRatio;

                window.sg_aspectRatio = this._config.aspectRatio;
                window.sg_element = this._element;
                window.onresize = function () {

                    //console.log('[SPAD] window.sg_aspectRatio: ' + window.sg_aspectRatio)
                    if (window.sg_aspectRatio > 0) {
                        //console.log('[SPAD] window.sg_element.height: ' + window.sg_element.height)
                        window.sg_element.height = window.sg_element.width / window.sg_aspectRatio;
                    }
                }
            }
        }, 500);
